...
INFO = {
    ...
    "bac_friday_evening":       ("S13", "يعاقب: قسم باكالوريا يدرس مساء الجمعة"),
    "travel_pair":              ("S21", "يعاقب: زميلا نقل مشترك يحضران في أيام مختلفة"),
    "bac_no_free_afternoon":    ("S17", "يعاقب بشدة: قسم باكالوريا بقي بلا أي مساء حر إثنين-خميس (الهدف عكسه تماما: مساء حر)"),
    "bac_busy_afternoon":       ("S17", "يعاقب كل مساء مشغول لقسم باكالوريا - الهدف: أكبر عدد ممكن من الأمسيات الحرة (طلب مجد)"),
    ...
    "group_pair_swap":          ("S20", "مادتا أفواج لا تتبادلان في نفس الحصة (فوج تقنية وفوج علوم يتبادلان)"),
    "teacher_lone_half":        ("S2", "يعاقب: أستاذ له ساعة واحدة يتيمة في نصف يوم (جاء لساعة 11 ثم انتظر الغداء)"),
    "hard_subject_last":        ("S3", "يعاقب بشدة: مادة صعبة في الحصة الأخيرة من اليوم (طلب مجد)"),
    "flexible_day_off":         ("H7", "يعاقب بقوة: ساعة تدريس في يوم الراحة الذي اختاره البرنامج (اليوم المكتوب في الجدول يبقى مقدسا)"),
    "cross_lunch":              ("S2", "يعاقب قليلا: يوم يمتد على الصباح والمساء معا (من لا يعود لبيته يجلس وقت الغداء)"),
}
