...
SHEETS = {
    ...
    "Subjects": dict(
        ...
        hint=["MATH, PHYS...", "Arabic or French", "grid abbreviation",
              ...
              "yes = 24h between its sessions (Sport, circular III.2)",
              "subject ids this must not directly follow (PHIL: SPORT)",
              "literary/scientific/social - no two of a kind back to back"],
        dv={"difficulty": "hard,medium,easy",
            "room_type": "normal,lab_phys,lab_chem,lab_sci,it,gym,tech",
            "minmax_exempt": "yes,no", "gap24": "yes,no",
            "nature": "literary,scientific,social"},
        width={"name": 30, "avoid_after": 13, "minmax_exempt": 15,
               "not_after": 16}),
    "Curriculum": dict(
        cols=["class_id", "subject_id", "hours", "teacher_id", "blocks",
              "groups", "room_type", "core", "week"],
        hint=["from Classes", "from Subjects",
              "periods per week - PER GROUP when groups > 1",
